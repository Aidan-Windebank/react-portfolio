    ...
    <>
      <Container fluid>
        <Row className="m-5" >
          ...
          <Col lg={8}>
            <h3>About Me</h3>
            <p>Greetings, I'm Aidan Windebank, a Minnesota native who embarked on a unique journey through life. Following my college years in sunny Arizona, I ventured into the outdoors, spending four exhilarating years as a ski patroller. My path meandered through roles as a Park Ranger and a US Forest Service Biologist, allowing me to immerse myself in the natural wonders of this world.
